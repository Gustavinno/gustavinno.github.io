...
//Busqueda por titulo, pulsando el boton buscar
 ...
 */
function filtrarPeliculas(idElementBusqueda, nombreAtributoBusqueda) {
    clearCards();
    const textoBusqueda = document.querySelector(idElementBusqueda).value;
    peliculasFiltradas =
